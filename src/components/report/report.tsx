...
import { HeroRevealItem, HeroStagger } from "@/components/motion/scroll-reveal";
    ...
    <HeroStagger className="flex flex-col gap-4" stagger={0.1}>
      ...
      <HeroRevealItem variant="fade-left">
        <div>
          ...
          <p>
            Ценности — это устойчивые убеждения, появляющиеся под влиянием
            семьи, личных достижений или препятствий. Они формируются с детства
            и определяют ваши выборы и поведение в жизни.
          </p>
        </div>
      </HeroRevealItem>
      ...
      <HeroRevealItem variant="fade-up">
        <div>
          ...
          <p>
            <strong>Уровень идеалов:</strong> «Я считаю, что в жизни важным
            должно быть ...» — ценности, как убеждения, которые важны Вам лично.
          </p>
          <p>
            <strong>Уровень поведения:</strong> «Я делаю так, чтобы оправдать
            ожидания окружающих о том, что должно быть важным» — ценности,
            которые по Вашему мнению, соответствуют ожиданиям окружающих людей.
          </p>
        </div>
      </HeroRevealItem>
