    ...
    <div id={id} className="flex flex-col gap-5 mt-16 lg:mt-24">
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-4">
        <div className="flex flex-col gap-2">
          <p className="text-primary font-semibold">Миссия</p>
        ...
        <div className="flex flex-col gap-2">
          <p className="text-primary font-semibold">Как мы это делаем</p>
          <p className="font-normal">
        ...
        <div className="flex flex-col gap-2">
          <p className="text-primary font-semibold">Зачем мы это делаем</p>
          <p className="font-normal">
